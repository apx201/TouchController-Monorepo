...
import top.fifthlight.touchcontroller.common.layout.HideHudButton
import kotlin.math.round
import kotlin.uuid.Uuid

@Serializable
@SerialName("hide_hud_button")
data class HideHudButton(
    val size: Float = 1f,
    val classic: Boolean = true,
    override val id: Uuid = fastRandomUuid(),
    override val name: Name = Name.Translatable(Texts.WIDGET_HIDE_HUD_BUTTON_NAME),
    ...
    companion object : KoinComponent {
        ...
        private val _properties = properties + persistentListOf<Property<HideHudButton, *>>(
            FloatProperty(
                getValue = { it.size },
                ...
                messageFormatter = {
                    textFactory.format(
                        Texts.WIDGET_HIDE_HUD_BUTTON_PROPERTY_SIZE,
            ...
            BooleanProperty(
                ...
                name = textFactory.of(Texts.WIDGET_HIDE_HUD_BUTTON_PROPERTY_CLASSIC),
            )
    ...
    override fun layout(context: Context) {
        context.HideHudButton(config = this)
    }

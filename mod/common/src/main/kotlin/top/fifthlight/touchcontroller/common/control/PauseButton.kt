...
import top.fifthlight.touchcontroller.common.layout.PauseButton
...
data class PauseButton(
    ...
    override val name: Name = Name.Translatable(Texts.WIDGET_PAUSE_BUTTON_NAME),
    ...
    companion object : KoinComponent {
        ...
        private val _properties = properties + persistentListOf<Property<PauseButton, *>>(
            FloatProperty(
                getValue = { it.size },
            ...
            BooleanProperty(
                ...
                name = textFactory.of(Texts.WIDGET_PAUSE_BUTTON_PROPERTY_CLASSIC),
            )

package top.fifthlight.touchcontroller.ui.screen.itemlist
...
import top.fifthlight.touchcontroller.gal.VanillaItemListProvider.CreativeTab
...
class VanillaItemListScreen(
    ...
    private val tabs: PersistentList<CreativeTab>,
            ...
            selectedTab?.let { tab ->
                Column(
                    ...
                    when (selectedTab.type) {
                        ...
                        CreativeTab.Type.SURVIVAL_INVENTORY -> {
                            Box(

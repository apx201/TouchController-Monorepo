...
import top.fifthlight.touchcontroller.common.layout.PanoramaButton
...
data class PanoramaButton(
    ...
    override val name: Name = Name.Translatable(Texts.WIDGET_PANORAMA_BUTTON_NAME),
    ...
    companion object : KoinComponent {
        ...
        private val _properties = properties + persistentListOf<Property<PanoramaButton, *>>(
            FloatProperty(
                getValue = { it.size },
            ...
            BooleanProperty(
                ...
                name = textFactory.of(Texts.WIDGET_PANORAMA_BUTTON_PROPERTY_CLASSIC),
            )

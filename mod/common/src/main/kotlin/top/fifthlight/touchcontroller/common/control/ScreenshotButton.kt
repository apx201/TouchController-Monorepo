...
import top.fifthlight.touchcontroller.common.layout.ScreenshotButton
...
data class ScreenshotButton(
    ...
    override val name: Name = Name.Translatable(Texts.WIDGET_SCREENSHOT_BUTTON_NAME),
    ...
    companion object : KoinComponent {
        ...
        private val _properties = properties + persistentListOf<Property<ScreenshotButton, *>>(
            FloatProperty(
                getValue = { it.size },
                ...
                messageFormatter = {
                    textFactory.format(
                        Texts.WIDGET_SCREENSHOT_BUTTON_PROPERTY_SIZE,
    ...
    override fun layout(context: Context) {
        context.ScreenshotButton(config = this)
    }

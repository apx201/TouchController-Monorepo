...
import top.fifthlight.touchcontroller.common.layout.ChatButton
...
data class ChatButton(
    ...
    companion object : KoinComponent {
        ...
        private val _properties = properties + persistentListOf<Property<ChatButton, *>>(
            FloatProperty(
                getValue = { it.size },
            ...
            BooleanProperty(
                ...
                name = textFactory.of(Texts.WIDGET_CHAT_BUTTON_PROPERTY_CLASSIC),
            )
